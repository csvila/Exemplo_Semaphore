...
namespace ExemploSemaphore
{
    public class ExemploSemaforo
    {
        ...
        //este flag é apenas para indicar que estamos na thread desordenada, então temos que chamar o waitOne nos métodos
        private static bool flag = false;

        public static void ThreadOrdenada()
        {
            Console.WriteLine("Threads Ordenadas");

            //este buffer será criado para garantir que as threads sejam executadas na ordem em que foram chamadas (criadas)
        ...
        /// </summary>
        public static void ThreadAleatoria()
        {
